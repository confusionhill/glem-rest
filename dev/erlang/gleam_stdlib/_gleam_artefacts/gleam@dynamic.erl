...
-spec optional(fun((dynamic_()) -> {ok, DXM} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        gleam@option:option(DXM)} |
    {error, list(decode_error())}).
optional(Decode) ->
...
-spec any(list(fun((dynamic_()) -> {ok, EBM} | {error, list(decode_error())}))) -> fun((dynamic_()) -> {ok,
        EBM} |
    {error, list(decode_error())}).
any(Decoders) ->
...
-spec result(
    fun((dynamic_()) -> {ok, DXA} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DXC} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {ok, DXA} | {error, DXC}} |
    {error, list(decode_error())}).
...
-spec list(fun((dynamic_()) -> {ok, DXH} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        list(DXH)} |
    {error, list(decode_error())}).
list(Decoder_type) ->
    fun(Dynamic) ->
...
-spec map_errors(
    {ok, DVV} | {error, list(decode_error())},
...
-spec field(
    any(),
    fun((dynamic_()) -> {ok, DXW} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, DXW} | {error, list(decode_error())}).
...
-spec optional_field(
    any(),
    fun((dynamic_()) -> {ok, DYA} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, gleam@option:option(DYA)} |
    {error, list(decode_error())}).
...
-spec tuple2(
    fun((dynamic_()) -> {ok, DZI} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DZK} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {DZI, DZK}} | {error, list(decode_error())}).
...
) -> fun((dynamic_()) -> {ok, {DZN, DZP, DZR}} | {error, list(decode_error())}).
...
-spec tuple4(
    fun((dynamic_()) -> {ok, DZU} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DZW} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DZY} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, EAA} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {DZU, DZW, DZY, EAA}} |
    {error, list(decode_error())}).
...
-spec tuple5(
    ...
    fun((dynamic_()) -> {ok, EAJ} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, EAL} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {EAD, EAF, EAH, EAJ, EAL}} |
    {error, list(decode_error())}).
...
-spec tuple6(
    ...
    fun((dynamic_()) -> {ok, EAU} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, EAW} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, EAY} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {EAO, EAQ, EAS, EAU, EAW, EAY}} |
    {error, list(decode_error())}).
...
) -> fun((dynamic_()) -> {ok, gleam@map:map_(EBB, EBD)} |
    {error, list(decode_error())}).
...
) -> fun((dynamic_()) -> {ok, EBW} | {error, list(decode_error())}).
...
-spec decode3(
    ...
    fun((dynamic_()) -> {ok, ECB} | {error, list(decode_error())}),
...
) -> fun((dynamic_()) -> {ok, ECM} | {error, list(decode_error())}).
...
-spec decode5(
    fun((ECS, ECT, ECU, ECV, ECW) -> ECX),
    fun((dynamic_()) -> {ok, ECS} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, ECT} | {error, list(decode_error())}),
...
-spec decode7(
    fun((EDS, EDT, EDU, EDV, EDW, EDX, EDY) -> EDZ),
    fun((dynamic_()) -> {ok, EDS} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, EDT} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, EDU} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, EDV} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, EDW} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, EDX} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, EDY} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, EDZ} | {error, list(decode_error())}).
...
-spec decode8(
    fun((EEI, EEJ, EEK, EEL, EEM, EEN, EEO, EEP) -> EEQ),
    fun((dynamic_()) -> {ok, EEI} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, EEJ} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, EEK} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, EEL} | {error, list(decode_error())}),
    ...
    fun((dynamic_()) -> {ok, EEP} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, EEQ} | {error, list(decode_error())}).
...
-spec decode9(
    fun((EFA, EFB, EFC, EFD, EFE, EFF, EFG, EFH, EFI) -> EFJ),
    ...
    fun((dynamic_()) -> {ok, EFF} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, EFG} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, EFH} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, EFI} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, EFJ} | {error, list(decode_error())}).
